package com.project.interface_adapters.core.editor;

import com.project.use_cases.editor.EditorInputBoundary;

import java.util.HashMap;

public class EditorTileManager implements EditorInputBoundary {
